        ...
        <main id="termsPage">
            ...
            <section className="terms-sections">
                ...
                <p className="terms-sections__text">
                    ...
                    No other terms or changes to the terms & conditions shall be binding unless agreed in writing signed by RollNES.
                </p>
                 ...
                 <ul className="terms-sections__list">
                    ...
                    <li>All personal information you provide RollNES with or that RollNES obtain will be handled by RollNES as responsible for the personal information.</li>
                    <li>Events outside RollNES control shall be considered force majeure.</li>
